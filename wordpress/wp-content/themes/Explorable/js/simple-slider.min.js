...
(function (e, t) {
    ...
    return n = function () {
        ...
        return t.prototype.createDivElement = function (t) {
            ...
            var r, i, s;
            n == null && (n = !1), r = e - this.slider.offset().left, r = Math.min(this.slider.outerWidth(), r), r = Math.max(0, r);//console.log(this.pagePos);
            document.getElementById("volumeValue").value = parseInt(r);
            volumeValue(parseInt(r));
            ...
            if (t && this.settings.animate) {
                ...
                if (this.settings.highlight) return this.highlightTrack.animate({
                    width: e
                }, 200)
            } else {
                this.dragger.css({
                ...
                if (this.settings.highlight) return this.highlightTrack.css({
                    width: e
                })
            }
