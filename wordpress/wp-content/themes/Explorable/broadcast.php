...
$mirror = $_POST['mirrorFlag'];
$cameraNo = $_POST["camNumber"];
	...
	var periodClientServerGmtTime = clientCurrGmtTime - serverCurrGmtTime.getTime();
		...
		jQuery($.ajax({
			...
			$(document).ready(function() {
				...
				ChatServer = new FancyWebSocket('ws://<?php echo RTMP_WOWZA?>:9300/ChatServer.php');
...
<script type="text/javascript">
            ...
            var mirror = "<?php echo $mirror?>";
            var cameraNo = "<?php echo $cameraNo?>";
            ...
            if ( mirror == "mirror" ) {
            	var flashvars = {"URL": "<?php echo RTMP_WOWZA?>"+"livestream","CHNL": "mp4:<?php echo $liveUrl?>","WDTH": 320,"HGHT": 240,"FPS": 15,"BW":90000,"QLT":90,"INV":30};
            }
            else {
            	var flashvars = {"URL": "<?php echo RTMP_WOWZA?>"+"livestream","CHNL": "mp4:<?php echo $liveUrl?>","WDTH": 320,"HGHT": 240,"FPS": 15,"BW":90000,"QLT":90,"INV":30};
            }
...
<!-- 	<input type="button" id="recorgin" name="button" value="recording" onclick="recordingtest();">   -->
				  ...
				  <tr>
				    <td width="30%" rowspan="4" style="padding-left: 3px;">
				      ...
				      if($image_path != "") 
				      	...
				      	echo "https://graph.facebook.com/" . $facebook_id . "/picture/?type=large";
