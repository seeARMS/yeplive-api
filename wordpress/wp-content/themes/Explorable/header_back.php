...
<div id="register_popup" class="popup" style="padding:0px; z-index: 1000000;">
    ...
    <iframe id="loginFrame" frameborder="no" src="" style="width:410px;height:450px;z-index: 1000000;">
	</iframe>
</div>
...
<!--			
				<div style="width:50px;float:right; border-right: 1px solid #b0b0b0;" align="center">
					<a href="<?php echo home_url( '/' )?>/broadcast/"> 
					<a href="<?php echo home_url( '/' )?>/add-program/">
					<a onclick="onPostClick()" href="javascript:void(0);">
						<img title="Post Live" id="postImage" style="width:25px;height:25px; " src="<?php echo get_template_directory_uri()?>/images/post.png">
					</a>
				</div>
				
				<div style="width:50px; float:right;border-right: 1px solid #b0b0b0;" align="center">
					<a href="javascript:void(0);">
						<img title="Help" id="helpImage" style="width:25px;height:25px; " src="<?php echo get_template_directory_uri()?>/images/help.png">
					</a>
					
				</div>
				
				<div style="width:50px;float:right;border-right: 1px solid #b0b0b0; text-align: center;" >
					<a href="javascript:void(0);">
						<?php
					if ($_SESSION['twitter_login'] == '1')  {
					?>
						<img id="imgTwitter" title="Twitter Login" onclick="fn_twitterLogin();" style="display:none; width:25px;height:25px; " src="<?php echo get_template_directory_uri()?>/images/twitter.png">
						<img id="imgTwitterVerified" title="Twitter Login" style="width:25px;height:25px; " src="<?php echo get_template_directory_uri()?>/images/twitter_verified.png">
					<?php
					} else { 
					?>
						<img id="imgTwitter" title="Twitter Login" onclick="fn_twitterLogin();" style="width:25px;height:25px; " src="<?php echo get_template_directory_uri()?>/images/twitter.png">
						<img id="imgTwitterVerified" title="Twitter Login" style="display:none; width:25px;height:25px; " src="<?php echo get_template_directory_uri()?>/images/twitter_verified.png">
					<?php
					} 
					?>
					</a>
				...
				<div style="width:50px;float:right; border-right: 1px solid #b0b0b0;" align="center">
					...
					?>
						<img id="imgFacebook" title="Facebook Login" onclick="fn_facebookLogin();" style="display:none; width:25px;height:25px; cursor: pointer;" src="<?php echo get_template_directory_uri()?>/images/facebook.png" />
						<img id="imgFacebookVerified" title="Facebook Login" style="width:25px;height:25px; cursor: pointer;" src="<?php echo get_template_directory_uri()?>/images/facebook_verified.png" />
					<?php
					} else { 
					?>
						<img id="imgFacebook" title="Facebook Login" onclick="fn_facebookLogin();" style="width:25px;height:25px; cursor: pointer;" src="<?php echo get_template_directory_uri()?>/images/facebook.png" />
						<img id="imgFacebookVerified" title="Facebook Login" style="display:none; width:25px;height:25px; cursor: pointer;" src="<?php echo get_template_directory_uri()?>/images/facebook_verified.png" />
					<?php
					} 
					?>
					</a>
...
-->				
				<div class="menu_wrapper">
                    <div class="nav-button" id="nav-button" onclick="show_menu();">
                        <a class="arrow">
                            <img class="nav_image" src="<?php echo $template_directory_uri; ?>/images/menu_block.png">
                            CATEGORIES
				...
				<div class="sign_in" align="center">
                    ...
                    <a href="javascript:void(0);" onclick="fn_register();">	
						<img title="Log in" id="loginImage" src="<?php echo get_template_directory_uri()?>/images/Addkey.png">SIGN IN</a>
					<?php }
					else {?>
                    <a href="javascript:void(0);" onclick="fn_logout();">
						<img title="Log out" id="logoutImage" src="<?php echo get_template_directory_uri()?>/images/logout2.png">SIGN OUT</a>
					<?php }?>
        ...
        <div class="nav_container" id="nav_container">
            <?php
                ...
                foreach ( (array) $menu_items as $key => $menu_item ) {
                    ...
                    $url = $menu_item->url;
                    if ($i == 0){
                        $menu_list .= '<div class="sub_wrap1"><a href="' . $url . '">' . $title . '</a></div><div style="font-size: 18px;"><div class="sub_wrap">';
                        $i = 1;    
                    } else {
                        if ($i > 2){
                            $i = 1;
                        ...
                        if ($i == 1){
                            $menu_list .= '<div class="sub_menu1"><a href="' . $url . '">' . $title . '</a></div>';   
                        } else {
                            $menu_list .= '<div class="sub_menu2"><a href="' . $url . '">' . $title . '</a></div>';
                        }
                        $i += 1;                                    
                    }
                }
