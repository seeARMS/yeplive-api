			...
			<div class="header_right">
				...
				<div class="record_button" align="center">
					...
					<a onclick="onPostClick()" href="javascript:void(0);">
						<img title="Post Live" id="postImage" class="post_image" src="<?php echo get_template_directory_uri()?>/images/post.png">
					</a>
				</div>
<!--				
...
-->				
             ...
             <!--  *********************************** category menu ************************************* -->  
				...
				<div class="sign_in" align="center" onmouseover="loginFoverInEvent();" onmouseout="loginFoverOutEvent();">
					
					<?php if(!isset($_SESSION['user_id'])){?>
                    <a href="javascript:void(0);" onclick="fn_register();">	
						<img title="Log in" id="loginImage" class="sign-image" src="<?php echo get_template_directory_uri()?>/images/Addkey.png">  SIGN IN</a>
				...
				<script type="text/javascript">
					function loginFoverInEvent () {
						//alert('ok');	
					}				
					function loginFoverOutEvent () {
						//alert('nok');
					}
				</script>					
