...
<form name="aform" method="post"  style="overflow:hidden;">
	...
	<div style="width: 410px; height: 420px; display: block; position: absolute; top: 0px; left: 0px; overflow: visible;border-radius:10px;">
					...
					<div class="join_header" align="center" style="text-align: center;border-radius:10px;">
						...
						<div class="content" style="margin-top:20px;border-radius:10px;" aign="center">
							<table border="0" cellspacing="10" cellpadding="10" style="border-collapse: collapse; width:100%;border-radius:10px;">
								...
								<tr style="height: 75px; line-height: 31px;">
									<td align="right">
										<span>User Name</span>
									</td>
									<td>
										...
										<table border="0" cellspacing=0 cellpadding=0 style="width:100%;height:100%;">
											...
											<tr>
												<td align="center" valign="top" style="padding-top:10px;">
													<input type="button" onclick="onBtnCreate();" value="Create" style=" color:#ffffff; letter-spacing: 3px; width:120px; cursor:pointer; height:45px; border-radius:25px;
								...
								<tr >
									<td colspan="2" align="center" style="height:25px;padding:0px; margin:0px; ">
										...
										<a style="float:right; padding-right: 23px; margin-top: 2px;" href="<?php echo home_url() ?>/login/"><span>Go back</span></a>
									</td>
								</tr>
