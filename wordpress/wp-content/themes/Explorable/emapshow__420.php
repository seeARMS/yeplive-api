...
/*		 param.name = "initialBufferTime";
		...
		if( EndTime == "" || EndTime == 0 )											//  check whether selected video is Mobile or not 
		{
			...
			if(  bMobile == "0")
			{
				...
				param.value = "URL=rtmp://ec2-50-112-62-239.us-west-2.compute.amazonaws.com:1935/livestream/" + channelNum + "_" + programNum + "_" + userNum + "&autoPlay=true&streamType=live&bgColor=#000000&status=livestream";
			}
			else
			{
